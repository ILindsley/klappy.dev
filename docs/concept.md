...
In practice, this creates three recurring failures: 1. Prompt entropy
• Dozens of fragile prompts and markdown files
• Each tool (Claude Code, Cursor, etc.) requires re-teaching
• Drift over time; nothing is canonical 2. False completion
• Agents confidently claim “it works”
• They didn’t actually run it
• They didn’t verify behavior
• They didn’t look at the UI
• A human becomes the QA manager repeating the same objections 3. Infinite possibility, no curation
